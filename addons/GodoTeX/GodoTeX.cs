...
public partial class GodoTeX : EditorPlugin {
	public override void _EnterTree() {
		...
		var control_script = GD.Load<Script>("addons/GodoTeX/LaTeXtureRect.cs");
		AddCustomType("LaTeXtureRect", "TextureRect", control_script, texture_button);
	...
	public override void _ExitTree() {
		...
		RemoveCustomType("LaTeXtureRect");
